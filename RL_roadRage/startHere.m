...
%->>>>
tempGrid = [ roadBasisGridMaps(1).Grid; roadBasisGridMaps(2).Grid; ...
    roadBasisGridMaps(2).Grid; roadBasisGridMaps(2).Grid; ...
    roadBasisGridMaps(2).Grid; roadBasisGridMaps(2).Grid; ...
    roadBasisGridMaps(2).Grid; roadBasisGridMaps(2).Grid; ...
    roadBasisGridMaps(2).Grid; roadBasisGridMaps(2).Grid; ...
    roadBasisGridMaps(2).Grid; roadBasisGridMaps(2).Grid; ...
    roadBasisGridMaps(4).Grid; roadBasisGridMaps(4).Grid; ...
    roadBasisGridMaps(3).Grid; roadBasisGridMaps(3).Grid; ...
    roadBasisGridMaps(2).Grid; roadBasisGridMaps(2).Grid; ...
